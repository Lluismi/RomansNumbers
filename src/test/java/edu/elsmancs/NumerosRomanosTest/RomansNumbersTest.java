package edu.elsmancs.NumerosRomanosTest;
...
import edu.elsmancs.NumerosRomanos.RomansNumbers;

public class RomansNumbersTest {
	
	 public static RomansNumbers numeroRomano;

	    @BeforeClass
	    public static void setup() {
	        numeroRomano = new RomansNumbers();
